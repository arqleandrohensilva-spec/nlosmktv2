  ...
  return (
    <>
      <PageHeader
        ...
        title="Integrações"
        description="Conecte serviços externos ao NL OS MKT. As credenciais são armazenadas com segurança no backend. (O cérebro da marca agora fica em Marca → Régua NL Arquitetos.)"
      />
